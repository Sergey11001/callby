const accordionItems=[
    ...
    },
    {
        ...
        titleItem:"Специально для вас мы подготовили безлимитное количество подключений пользователей, чтобы вы могли пообщаться с наибольшим количеством человек.",
    },
    {
    ...
    },
    {
        ...
        titleItem:"Конечно можно, специально для вас мы сделаем индивидуальный тариф, который подойдет под ваш бизнес-проект.",
    },
    {
        titleHead:"Могу ли я передать подписку на тариф другому пользователю?",
        titleItem:"К сожалению, передача подписки на тариф в приложении не осуществляется, но вы можете подарить подписку любому пользователю на 3-6-12 месяцев.",
    },
]
