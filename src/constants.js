...
const tariffBlocksLongList=[
    {title:"FREE 🧢",descriptionList:["Режим совместного редактирования/доски (ограниченный режим);","Совместное использование 2 пользователей;","Шумоподавление;","Планировщик ограниченные инструменты;","Облачное хранилище 50гб;","Виджеты (ограниченный набор)/комнаты 2 штуки;","Голосовой ассистент;","Набор FREE из магазина\n" +
        "2 звука\n" +
        "2 темы \n" +
        "5 стикер паков;"],price:0},
    {title:"PRO 🎓",descriptionList:["Субтитры;","Облачное хранилище 100гб;","Режим совместностного редактирования/доски (расширенный режим);","Синхронизация музыки с вашим аккаунтом;","Анонимное посещение звонков;","Статистика для звонков;","Виджеты (ограниченый набор);","Комнаты +1 штука;","Набор Pro из магазина \n" +
        "2 звука Pro уникальные \n" +
        "2 темы Pro уникальные \n" +
        "2 стикер пака Pro уникальные;"],price: 99},
    {title:"PRO PRIME 👑",descriptionList:["Анонимное посещение звонков;","Синхронизация музыки с вашим аккаунтом;","Субтитры;","Статистика звонков;","Облачное хранилище 250гб;","Виджеты (полная версия);","Комнаты + 3 штуки;","Сводка правил под звонки/каналы;","Режим совместного редактирования доски (полный режим)", "Отображение тех, кто не подключился к звонку", "Набор PRO PRIME \n" +
        "Звук 2 из Pro +2 pro prime\n" +
        "Темы 2 из Pro +2 pro prime \n" +
        "Стикер пак 2 из Pro +2 pro prime"],price: 249}
]
